...
- coordinate one durable writer per checkout while keeping read-only inspection available
- replay side-effecting retries by stable `operation_id` instead of executing them twice
