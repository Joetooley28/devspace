...
`skills://<name>` URI before following that skill. The bare URI loads the
skill entry file, while bundled resources use
`skills://<name>/<relative-path>`. Physical skill paths stay internal to
DevSpace.
